...
class Rental extends CI_Controller {
    ...
    public function selectcar()
    {
        ...
        Carregis.idCarregis NOT IN (SELECT Rental.idCarregis FROM Rental WHERE (('2020-02-27' BETWEEN Rental.startDate and Rental.endDate) OR ('2020-02-27' BETWEEN Rental.startDate and Rental.endDate)) AND Rental.id_status <> '6' AND Rental.id_status <> '3') AND Carregis.id_Status = '5' AND Images.id_image = (SELECT Images.id_image FROM Images WHERE Images.idCarregis = Carregis.idCarregis LIMIT 1)");
