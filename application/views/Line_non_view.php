...
$token = "kn5GxiynrUnZ7iVDSk7buDe6kvXmPmA7Ak21aJUSGdx"; //ใส่Token ที่copy เอาไว้
$str = $_POST['txtline']; //"ไอสัส line เด้งมาแล้ว"; //ข้อความที่ต้องการส่ง สูงสุด 1000 ตัวอักษร
