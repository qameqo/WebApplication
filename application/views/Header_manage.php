...
<!-- CSS Files 
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/.min.css?v=2.0.6">
	...
	color: #EACA6A;">
			...
			<div class="collapse navbar-collapse">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a href="#pablo" class="nav-link">กาณฑ์การประเมิน</a>
					</li>
					<li class="nav-item">
