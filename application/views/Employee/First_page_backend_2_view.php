      ...
      <div class="col-sm-7">
        <div class="card text-center">
          <div class="card-body">
            ...
            <a href="<?php echo site_url('emp/emp_edit');?>" class="btn btn-primary btn-lg" style="font-size : 18px">แก้ไขข้อมูลส่วนตัว</a><br>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-7">
        <div class="card text-center">
          <div class="card-body">
            ...
            <a href="<?php echo site_url('Emp_rental');?>" class="btn btn-primary btn-lg mt-5" style="font-size : 18px">จัดการข้อมูลการเช่ารถยนต์</a><br>
            <a href="<?php echo site_url('Emp_rental/index_2');?>" class="btn btn-primary btn-lg" style="font-size : 18px">ตรวจสอบข้อมูลการเช่ารถยนต์</a><br>
          </div>
        </div>
      </div>
