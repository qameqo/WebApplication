 		...
 		<div class="row justify-content-center">
 			<div class="col-sm-8 shadow p-4 mb-4 bg-white rounded">
 				<div class="container">
 					...
 					<div class="row">
 						<div class="col-sm">
 							<H5 style="color: red;">* กรุณาอัปโหลดอย่างน้อย 4 รูปโดยรูปแรกจะเป็นรูปโปรไฟล์รถ</H5>
 								...
 								<div class="modal-dialog modal-dialog-centered" role="document">
 									<div class="modal-content">
 										<div class="modal-header">
 											<h5 class="modal-title" id="exampleModalLabel">ตัวอย่างรูปภาพรถยนต์</h5>
 										...
 										<div class="modal-body text-left">
										 		 <img src="<?php echo base_url('./pic/excar3.jpg');?>"
 												alt="ภาพตัวอย่าง" height="70" width="85" />
												 <img src="<?php echo base_url('./pic/excar4.jpg');?>"
 												alt="ภาพตัวอย่าง" height="70" width="85" />
												 <img src="<?php echo base_url('./pic/excar5.jpg');?>"
 												alt="ภาพตัวอย่าง" height="70" width="85" />
												 <img src="<?php echo base_url('./pic/excar6.jpg');?>"
 												alt="ภาพตัวอย่าง" height="70" width="85" />
												 <img src="<?php echo base_url('./pic/excar7.jpg');?>"
 												alt="ภาพตัวอย่าง" height="70" width="85" />
 										</div>
 									...
 									<div class="modal-content">
 										...
 										<div class="modal-header">
 											<h6 class="modal-title" id="modal-title-default">
 												เอกสารสำหรับการลงทะเบียนรถยนต์
 											</h6>
 											<button type="button" class="close" data-dismiss="modal"
 												aria-label="Close">
 										...
 										<div class="modal-body text-left">
 											...
 											<img src="<?php echo base_url('./pic_tee/ใบขับขี่.jpg');?>"
 												alt="ภาพตัวอย่าง" height="70" width="85" />
 											<p>2.พ.ร.บ.</p>
